// Tarentaise Transfer Radar — анимиран пейзаж в лентата за времето
// Портирано от BAK (небе, звезди, луна, облаци, дъжд, сняг, птици,
// самолет, мъгла, светкавица). Без такси и без пътя за нея — по избор.
// Собствен, независим извор на данни (Open-Meteo, без ключ), координати Bozel, Tarentaise.
...
(function(){
  ...
  function pullWeather(){
    var url = 'https://api.open-meteo.com/v1/forecast?latitude=45.4436&longitude=6.6392'
            + '&current=temperature_2m,precipitation,cloud_cover,wind_speed_10m,is_day,weather_code'
            + '&hourly=precipitation_probability,precipitation,snowfall&forecast_days=2&timezone=Europe%2FParis';
